...
namespace SafeGameWinForms
{
    public partial class GameLogic : Form
    {
        ...
        private Level difficaltyLevel = Level.hard;                    // default field is level hard
        ...
        private static bool WinLabel(bool[,] addMatrix, Level difficaltyLevel)  // opens finish-game label when win
        {
